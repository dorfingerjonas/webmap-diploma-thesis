...
\def\titleone{webmap - Automatische Generierung von}
\def\titletwo{Websites zur Interaktiven}
\def\titlethree{Datenveranschaulichung}
%
...
%
\def\nameone{Jonas Dorfinger}
\def\nametwo{Sebastian Scholl}
%
% enter the name of the supervisor
%
\def\firstreferee{Dietmar Steiner}
%
% enter information about external partners or comment the line
%
\def\assist{Christopher Stelzmüller, triply GmbH}
%
...
\begin{center}
    \vspace{-2cm}
{\LARGE\bfseries\titleone}
{\LARGE\bfseries\titletwo}
\par
\medskip
{\LARGE\bfseries\titlethree}
